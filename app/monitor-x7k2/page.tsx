  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-6 max-w-6xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <StatCard label="Threads (last 200)" value={data.threads.length} />
        <StatCard label="Today's active users" value={data.dau[0]?.date === today() ? data.dau[0].count : 0} />
      ...
      {/* Threads */}
      <Section title={`All threads (${filteredThreads.length})`}>
        <input
          type="text"
