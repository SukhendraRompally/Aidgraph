...
import { LogOut, FileText, Zap, Shield, Menu } from 'lucide-react'
...
export function NavBar({ onMenuClick }: { onMenuClick?: () => void }) {
  ...
  return (
    <header className="flex items-center justify-between px-3 sm:px-4 h-12 border-b border-border/40 shrink-0">
